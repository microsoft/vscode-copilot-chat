...
export default tseslint.config(
	...
	// no-explicit-any
	{
		...
		ignores: [
			...
			'./src/extension/completions-core/vscode-node/lib/src/telemetry.ts',
			'./src/extension/completions-core/vscode-node/lib/src/test/context.ts',
			'./src/extension/completions-core/vscode-node/prompt/jsx-runtime/jsx-runtime.ts',
			...
			'./src/extension/completions-core/vscode-node/lib/src/prompt/contextProviderRegistry.ts',
