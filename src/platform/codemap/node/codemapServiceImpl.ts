...
export class CodemapServiceImpl implements ICodemapService {
	...
	private generateStructuredCodemap(node: CodemapNode, document: TextDocumentSnapshot): StructuredCodemap {
		...
		// Depth 4 is needed for React components where helper functions are defined inside the component:
		// depth=1: function_declaration (Component), depth=2: statement_block, depth=3: lexical_declaration, depth=4: variable_declarator with arrow functions
