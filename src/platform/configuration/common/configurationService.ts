...
export namespace ConfigKey {
	...
	*/
	export namespace TeamInternal {
		...
		export const InlineEditsUserHappinessScoreConfigurationString = defineTeamInternalSetting<string | undefined>('chat.advanced.inlineEdits.adaptivenessAggressivenessConfigurationString', ConfigType.ExperimentBased, undefined);
	...
	export const AnthropicContextEditingEnabled = defineSetting<boolean>('chat.anthropic.contextEditing.enabled', ConfigType.Simple, false);
