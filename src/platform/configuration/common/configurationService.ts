...
export namespace ConfigKey {
	...
	*/
	export namespace TeamInternal {
		...
		export const InlineEditsUserHappinessScoreConfigurationString = defineTeamInternalSetting<string | undefined>('chat.advanced.inlineEdits.userHappinessScoreConfigurationString', ConfigType.ExperimentBased, undefined);
