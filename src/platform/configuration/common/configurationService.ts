...
export namespace ConfigKey {
	...
	*/
	...
	/** Show a context usage indicator (token-based) in the chat UI. */
	export const ContextCounterEnabled = defineSetting<boolean>('chat.contextCounter.enabled', ConfigType.Simple, false);
