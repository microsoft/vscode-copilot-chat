...
export namespace ConfigKey {
	...
	*/
	export namespace TeamInternal {
		...
		export const InlineEditsXtabAggressivenessLevel = defineSetting<xtabPromptOptions.AggressivenessLevel | undefined>('chat.advanced.inlineEdits.xtabProvider.aggressivenessLevel', ConfigType.ExperimentBased, undefined);
