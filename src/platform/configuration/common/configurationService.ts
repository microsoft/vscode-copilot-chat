...
export namespace ConfigKey {
	...
	*/
	export namespace TeamInternal {
		...
		export const InlineEditsXtabAggresivityLevel = defineSetting<xtabPromptOptions.AggresivityLevel | undefined>('chat.advanced.inlineEdits.xtabProvider.aggresivityLevel', ConfigType.ExperimentBased, undefined);
