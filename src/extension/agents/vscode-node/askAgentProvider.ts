...
export function buildAskAgentBody(askQuestionTool: string = '#tool:vscode/askQuestions') {
...
- Use ${askQuestionTool} to clarify ambiguous questions before researching
...
3. **Clarify** if the question is ambiguous — use ${askQuestionTool}
