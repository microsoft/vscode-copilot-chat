		...
		return (
			<>
				...
				<UserMessage flexGrow={1}>
					...
					{this.props.chatVariables && this.props.query && <ChatVariablesAndQuery flexGrow={3} priority={900} chatVariables={this.props.chatVariables} query={this.props.query} sessionResource={undefined} />}
				</UserMessage>
			</>
		);
	}
