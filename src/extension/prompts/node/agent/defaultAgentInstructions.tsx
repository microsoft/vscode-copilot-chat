	...
	async render(state: void, sizing: PromptSizing) {
		...
		return <InstructionMessage>
			...
			<Tag name='toolUseInstructions'>
				...
				{tools[ToolName.BrowserVerification] && <>After making changes to web applications, consider using the {ToolName.BrowserVerification} tool to verify the UI renders correctly by taking a screenshot and validating page elements.<br /></>}
