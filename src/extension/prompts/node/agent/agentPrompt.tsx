...
class AgentTasksInstructions extends PromptElement {
	...
	render() {
		...
		return <>
			The following tasks can be executed using the {ToolName.RunTask} tool and if they are actively running, their output can be reviewed using the {ToolName.GetTaskOutput} tool:<br />
