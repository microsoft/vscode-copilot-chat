...
import { Conversation, getGlobalContextCacheKey, GlobalContextMessageMetadata, ICopilotChatResult, ICopilotChatResultIn, normalizeSummariesOnRounds, RenderedUserMessageMetadata, TokenUsageMetadata, Turn, TurnStatus } from '../common/conversation';
...
function createTurnFromVSCodeChatHistoryTurns(
	...
	if (turnMetadata?.promptTokens && turnMetadata?.outputTokens) {
		currentTurn.setMetadata(new TokenUsageMetadata(turnMetadata.promptTokens, turnMetadata.outputTokens));
	}
