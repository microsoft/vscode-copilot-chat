...
import { CodeSnippet, ContextProvider, ContextResolver, SupportedContextItem, Trait, type DiagnosticChunk } from '../../../../../types/src';
...
class TestContextProvider implements ContextProvider<Trait | CodeSnippet | DiagnosticChunk> {
	id: string;
	selector: string[];
	resolver: ContextResolver<CodeSnippet | Trait | DiagnosticChunk>;
