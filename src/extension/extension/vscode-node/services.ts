...
import { ChatContextCounterStatus } from '../../prompt/vscode-node/chatContextCounterStatus';
...
export function registerServices(builder: IInstantiationServiceBuilder, extensionContext: ExtensionContext): void {
	...
	builder.define(IChatContextCounterStatus, new SyncDescriptor(ChatContextCounterStatus, [undefined]));
