    ...
    with sync_playwright() as p:
        ...
        <body style="background-color: #1e1e1e; color: white; padding: 20px;">
          <div id="solutionsContainer">
            <vscode-button role="button" class="acceptButton" id="acceptButton0" appearance="secondary" data-solution-index="0" title="Click to insert this suggestion into your code">Accept suggestion 1</vscode-button>
          </div>
        </body>
        </html>
        """)
